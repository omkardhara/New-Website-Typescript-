      ...
      <div className="hero-grid">
        <div className="hero-left">
          ...
          <p className="hero-sub">
            Eleven years between painting walls, juggling knives, and managing ₹80 crore taught me one thing: what actually connects with people. That&apos;s what I bring to any brief.
          </p>
