...
export const TESTIMONIALS: Testimonial[] = [
  ...
  },
  {
    id: 3,
    quote:
      "We'd been making things in Marol for a while but nobody was paying attention outside our circle. The Wassup video changed that. Omkar pulled the whole thing together: Ranveer, Puma, the crew. Kept it from turning into something that felt like a brand exercise. That video did what it was supposed to. It opened a door.",
    name: 'MC Altaf',
